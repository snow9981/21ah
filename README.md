...
```text
https://naver.me/GB3ed1yk
https://blog.naver.com/carepaws
https://pf.kakao.com/_NxfUfX
{{PHONE_NUMBER}}
{{PRICE_NOTICE_URL}}
{{OWNER_NAME}}
{{BUSINESS_NUMBER}}
...
- 네이버 플레이스: `https://naver.me/GB3ed1yk`
- 네이버 블로그: `https://blog.naver.com/carepaws`
- 카카오톡 상담: `https://pf.kakao.com/_NxfUfX`
- 전화: `{{PHONE_NUMBER}}`
